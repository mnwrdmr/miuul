...
import pandas as pd
#read csv
df = pd.read_csv('/Users/macvbookpro/PycharmProjects/miuul/resource/ınterproscan/G_muris.tsv', sep='\t', names=list(range(0, 15)), engine='python', quoting=3)[[0, 3, 4, 5, 11, 12]]
