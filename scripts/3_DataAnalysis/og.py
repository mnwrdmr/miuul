...
path_OG_count = "/Users/macvbookpro/PycharmProjects/miuul/resource/orthofinder/OrthoFinder/Results_Jan20/Orthogroups/Orthogroups.GeneCount.tsv"
path_singletons = "/Users/macvbookpro/PycharmProjects/miuul/resource/orthofinder/OrthoFinder/Results_Jan20/Orthogroups/Orthogroups_UnassignedGenes.tsv"
out_0 = '/Users/macvbookpro/PycharmProjects/miuul/output/plot/color_palette_OG_analysis_upsetplot.png'
...
#pal = sns.light_palette("#69d", n_colors=2, reverse=False)
#pal = sns.cubehelix_palette(start=2, rot=0, dark=0.2, light=0.8, reverse=False, as_cmap=False)
