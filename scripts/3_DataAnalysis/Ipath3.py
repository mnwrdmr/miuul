...
eggnog = '/Users/macvbookpro/PycharmProjects/miuul/resource/eggnog/G_intestinalis.csv'
out_file = '/Users/macvbookpro/PycharmProjects/miuul/output/data/kegg_G_intestinalis.csv'
