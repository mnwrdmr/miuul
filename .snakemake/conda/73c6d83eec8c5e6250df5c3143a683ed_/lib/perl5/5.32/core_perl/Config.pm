...
tie %Config, 'Config', {
    ...
    libpth => "$compilerroot/lib/clang/16/lib $sdkroot/usr/lib",
    osname => 'darwin',
    osvers => '20.6.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/perl5/core_perl'),
    scriptdir => '/Users/macvbookpro/PycharmProjects/miuul/.snakemake/conda/73c6d83eec8c5e6250df5c3143a683ed_/bin',
